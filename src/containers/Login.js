              ...
              <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
                <div className='max-w-[320px] mx-auto py-16'>
                  ...
                  <input className='p-3 my-2 bg-cyan-100 rounded' type="email" name="email" id="3" onChange={onChange} value={email} required placeholder='Email'/>
                    ...
                    <button className='bg-cyan-500 py-3 my-6 rounded font-bold'>LogIn</button>
                    )}


                    <p className='text-white py-4'><span className='text-gray-400'>Don't have an Account ?</span><Link to='/register'> Sign Up</Link></p>
                  </form>
                </div>
              </div>
          </div>
